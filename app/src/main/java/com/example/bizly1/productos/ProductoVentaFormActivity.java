...
public class ProductoVentaFormActivity extends AppCompatActivity {
    ...
    private TextView txtCostoTotal, txtPrecioSugerido, txtEmptyInsumos;
    private RecyclerView recyclerViewInsumos;
    private MaterialButton btnGuardar, btnCancelar, btnAgregarInsumo;
    ...
    private void configurarToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(productoVentaId != null ? "Editar Producto" : "Nuevo Producto");
        }
    }
